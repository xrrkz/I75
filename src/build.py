...
/* ---- Metric-matched fallbacks -----------------------------------------
   ...
   Calibrated on the strings long enough to decide a line break, not on an
   average over the alphabet: Anton's letters run ~69% of Arial while its
   digits run ~89%, and averaging the two mis-sizes the headlines, which are
   the only Anton text that wraps.
